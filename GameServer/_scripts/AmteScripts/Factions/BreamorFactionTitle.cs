...
namespace DOL.GS.PlayerTitles
{
	...
	/// Example...
	/// </summary>
	public class BreamorFactionTitle : SimplePlayerTitle
	{
		/// <summary>
		...
		{
			return $"Votre rang d'affinité avec les Avernes ou les Helviens : {GetValue(player, player)}";
		}
		...
		{
			var (title, _details) = BreamorFactionMgr.GetRank(player);
			return title;
		}
